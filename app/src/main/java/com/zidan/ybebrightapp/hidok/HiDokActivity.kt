...
import com.zidan.ybebrightapp.databinding.HiDokActivityBinding
    ...
    private fun putImageInStorage(storageReference: StorageReference, uri: Uri, key: String?) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            storageReference.putFile(uri)
                .addOnSuccessListener(this@HiDokActivity) { taskSnapshot -> // After the image loads, get a public downloadUrl for the image
