...
import com.zidan.ybebrightapp.databinding.FragmentPembelianBinding
...
class PembelianFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        binding = FragmentPembelianBinding.inflate(layoutInflater, container, false)
        ...
        val query: Query = db
            .getReference("order")
            .orderByChild("buyerId").equalTo(id)

        val data = FirebaseRecyclerOptions.Builder<Order>()
            .setQuery(query, Order::class.java)
            .build()

        adapter = OrderAdapter(requireContext(), id, data, true) { it, isTrigger ->
